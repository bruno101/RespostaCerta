  ...
  "questionTypes": [
    {
      ...
      "description": "Solicita a apresentação clara e objetiva do significado de um termo, conceito, instituto ou sigla específica de uma área do conhecimento. Foco na precisão terminológica.",
      "examples": [
        "Defina avaliação.",
    ...
    },
    {
      ...
      "description": "Requer a descrição aprofundada de um tema, conceito, processo, funcionamento, características ou princípios, indo além da simples definição e exigindo detalhamento.",
      "examples": [
    ...
    },
    {
      ...
      "description": "Solicita a elaboração de um texto dissertativo sobre um tema central, cuja abordagem deve obrigatoriamente seguir uma estrutura pré-definida por tópicos (numerados ou em bullets) apresentados no comando da questão.",
      "examples": [
    ...
    },
    {
      ...
      "description": "Requer a elaboração de um texto dissertativo sobre um tema geral, oferecendo ao candidato maior liberdade na estruturação dos argumentos e na seleção dos aspectos a serem aprofundados. Pode haver sugestões gerais, mas sem uma lista rígida de tópicos obrigatórios.",
      "examples": [
    ...
    },
    {
      ...
      "description": "Apresenta uma situação fática detalhada, geralmente envolvendo aspectos legais, normativos ou éticos, e solicita uma análise dessa situação, aplicação de regras, identificação de irregularidades, direitos, deveres ou a resposta a questionamentos específicos sobre o caso.",
      "examples": [
    ...
    },
    {
      ...
      "description": "Apresenta um cenário, dados, diagramas ou especificações técnicas e requer a aplicação de conhecimentos científicos, de engenharia, TI, matemática, estatística, etc., para resolver um problema, analisar um sistema, interpretar dados, propor uma solução técnica ou realizar cálculos específicos.",
      "examples": [
    ...
    },
    {
      ...
      "description": "Solicita um posicionamento formal e fundamentado sobre uma questão ou situação específica, exigindo que o candidato assuma um papel profissional (juiz, contador, engenheiro, advogado, auditor, consultor) e utilize conhecimentos técnicos da área para embasar sua opinião ou recomendação.",
      "examples": [
    ...
    },
    {
      ...
      "description": "Requer a redação de um documento formal específico, geralmente do âmbito jurídico ou administrativo, como uma petição inicial, contestação, recurso, parecer jurídico formal (diferente do parecer técnico pela estrutura e contexto legal), relatório de auditoria, etc., seguindo a estrutura e linguagem adequadas.",
      "examples": [
    ...
    },
    {
      ...
      "description": "Solicita a proposição de um plano de ação, programa, projeto ou conjunto de medidas estruturadas para atingir um objetivo, resolver um problema ou implementar uma iniciativa, detalhando fases, ações, responsabilidades ou características.",
      "examples": [
    ...
    },
    {
      ...
      "description": "Exige a realização de uma tarefa técnica bem definida, como o desenvolvimento de um algoritmo, a execução de um cálculo complexo (matemático, estatístico, atuarial, financeiro) ou a demonstração prática de um processo ou teorema.",
      "examples": [
    ...
    },
    {
      ...
      "description": "Solicita predominantemente que o candidato liste ou enumere elementos (exemplos, características, tipos, fases, princípios, etc.) relacionados a um tema, sem a necessidade de aprofundamento ou desenvolvimento discursivo extenso para cada item.",
      "examples": [
        "Cite oito políticas...",
    ...
    },
    {
      ...
      "description": "Requer que o candidato analise dois ou mais conceitos, teorias, métodos, objetos ou institutos, apontando explicitamente suas semelhanças e/ou diferenças.",
      "examples": [
    ...
    },
    {
      ...
      "description": "Categoria residual para questões que, devido a erros de formatação nos dados, não são discursivas (ex: parecem ser de múltipla escolha, verdadeiro/falso) ou cujo comando é tão ambíguo, incompleto, contraditório ou incompreensível que impede uma classificação clara em qualquer um dos outros tipos definidos.",
      "examples": [
